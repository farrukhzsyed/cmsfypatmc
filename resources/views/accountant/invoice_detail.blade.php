          ...
          <div>
            <div class="dropdown dropstart">
              ...
              <div class="dropdown-menu"
                ...
                <a class="dropdown-item" href="{{route('accountant.download.invoice',Crypt::encrypt($invoice->id))}}">Download</a>
                @if(!($invoice->isPayEvidenceApproved && $invoice->paymentEvidence))
                  @if(!$invoice->isPayEvidenceApproved && $invoice->paymentEvidence )
                    <a class="dropdown-item" href="{{route('accountant.confirm.payment.invoice',Crypt::encrypt($invoice->id))}}">
                      Confirm Payment
                    </a>
                  @else
                  ...
                  @endif
                @endif 
                  <a class="dropdown-item" href="{{route('accountant.delete.invoice',Crypt::encrypt($invoice->id))}}" style="color:red;">Delete</a>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                  ...
                  <div class="col-6 mb-5">
                    ...
                    @if($invoice->paymentEvidence)
                      <p class="mb-0"> <a class="button" href="{{route('accountant.show.payment.evidence',Crypt::encrypt($invoice->id))}}">
