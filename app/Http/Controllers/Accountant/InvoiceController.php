...
class InvoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('accountant.view_invoice',compact('invoices'));
    }
    ...
    public function create()
    {
        ...
        return view('accountant.new_invoice', compact('projects','serial'));
    }
    ...
    public function store(InvoiceRequest $request)
    {
        ...
        $data['user_id'] = Auth::guard('accountant')->user()->id;
        $data['user_type'] = 'App\Models\Accountant';
        Invoice::create($data);
        ...
        return redirect()->route('accountant.view.invoices');
    }
    ...
    public function show($id)
    {
        ...
        return view('accountant.invoice_detail', compact('invoice'));
    }
    ...
    public function edit($id)
    {
        $invoice = Invoice::with('project')->with('client')->find(Crypt::decrypt($id));
        $projects = Project::with('client')->get();
        return view('accountant.edit_invoice', compact('invoice','projects'));
    }
    ...
    public function update(InvoiceRequest $request, $id)
    {
        ...
        return redirect()->route('accountant.show.invoice',$id);
    }
    ...
    public function confirmPayment($id)
    {
        ...
        $data['confirmed_user_id'] = Auth::guard('accountant')->user()->id;
        $data['confirmed_user_type'] = 'App\Models\Accountant';
